...
SPEEDRUNSERVERID = 1086729144307564648

AUTHSERVERS = [DEVSERVERID, GENSERVERID, DATASERVERID, WIKISERVERID, BINGOSERVERID, SPEEDRUNSERVERID]
...
SPEEDRUNSERVERROLID_MOD = 1086729521262231622

ADMINROLES = [GENSERVERROLEID_ADMIN, GENSERVERROLEID_SENIORMOD, GENSERVERROLEID_MOD, GENSERVERROLEID_TRIALMOD, DATASERVERROLEID_MOD, WIKISERVERROLEID_COMMUNITYSTAFF, SPEEDRUNSERVERROLID_MOD]
