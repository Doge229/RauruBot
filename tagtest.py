...
async def tag2(ctx, arg):
        ...
        #        NOTIFY = f'{messages.HELP_NOTIFY} {ctx.author.name}!'
        #        await ctx.reply(NOTIFY)
        #    except:
        #        NOTIFY = f'{messages.HELP_NOTIFYERROR1} {ctx.author.name}{messages.HELP_NOTIFYERROR2}'
        #        await ctx.reply(NOTIFY)
        #elif not IMAGEPATH == '':
        ...
        await system.respond(ctx, ANSWER, IMAGE)